    ...
    try:
        ...
        if _eq_cnt_val == 0:
            _EQUIP_SEED = [
                ...
                # Frota real (seriais dos certificados de calibração)
                ('bomba', 'SKC',    'AIRLITE',  'A060502',     '', 'disponivel', None, None, 'Bomba SKC AIRLITE'),
                ('bomba', 'SKC',    'AIRLITE',  'A061553',     '', 'disponivel', None, None, 'Bomba SKC AIRLITE'),
                ('bomba', 'SKC',    'AIRLITE',  'A061585',     '', 'disponivel', None, None, 'Bomba SKC AIRLITE'),
                ('bomba', 'SKC',    'AIRLITE',  'A062462',     '', 'disponivel', None, None, 'Bomba SKC AIRLITE'),
                ('bomba', 'SKC',    'AIRLITE',  'A63555',      '', 'disponivel', None, None, 'Bomba SKC AIRLITE'),
                ('bomba', 'Gilian', 'BDX-II',   '38356',       '', 'disponivel', None, None, 'Bomba Gilian BDX-II'),
                ('bomba', 'Gilian', 'BDX-II',   '38357',       '', 'disponivel', None, None, 'Bomba Gilian BDX-II'),
                ('bomba', 'Gilian', 'BDX-II',   '38358',       '', 'disponivel', None, None, 'Bomba Gilian BDX-II'),
                ('bomba', 'Gilian', 'BDX-II',   '38359',       '', 'disponivel', None, None, 'Bomba Gilian BDX-II'),
                ...
                ('bomba', 'Inlite', 'VENTUSPRO','25040902602B', '', 'disponivel', None, None, 'Bomba Inlite'),
                ('bomba', 'Inlite', 'VENTUSPRO','25040903102B', '', 'disponivel', None, None, 'Bomba Inlite'),
                ('bomba', 'Inlite', 'VENTUSPRO','25040907102B', '', 'disponivel', None, None, 'Bomba Inlite'),
